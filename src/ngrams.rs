...
mod trigram_tests {
    ...
    #[rstest]
    #[case::left_middle_ring_same_hand('c', 'a', 'w', vec![ TrigramKind::Scissor { units: 2, upper_finger: FingerKind::Ring, lower_finger: FingerKind::Middle, same_hand: true }, TrigramKind::Redirect { weak: true } ])]
